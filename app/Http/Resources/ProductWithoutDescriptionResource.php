...
class ProductWithoutDescriptionResource extends JsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        return [
            ...
            // 'description_en' => $this->description_en, // Excluded
            // 'description_bn' => $this->description_bn, // Excluded
            'featured_image' => $this->fi(),
            'price' => $this->price,
