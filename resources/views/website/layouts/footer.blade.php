            ...
            <div class="row">
                ...
                {{--<div class="col-xl-3 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-about-widget">
                        ...
                        <p>Sungoods connects farmers, distributors, and businesses through a smart supply chain network across Bangladesh.</p>
                        ...
                        <div class="footer-address">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="footer-address-info">
                                        <p><a href="mailto:info@Sungoods.com">info@Sungoods.com</a></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-12">
                    <p>© {{ date('Y') }} Sungoods Bangladesh – All Rights Reserved.</p>
                </div>
